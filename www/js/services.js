...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://ionic2-8f924.firebaseio.com/"),
    refCart = new Firebase("https://ionic2-8f924.firebaseio.com/cart"),
    refUser = new Firebase("https://ionic2-8f924.firebaseio.com/users"),
    refCategory = new Firebase("https://ionic2-8f924.firebaseio.com/category"),
    refOrder = new Firebase("https://ionic2-8f924.firebaseio.com/orders"),
    refFeatured = new Firebase("https://ionic2-8f924.firebaseio.com/featured"),
    refMenu = new Firebase("https://ionic2-8f924.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
